...
function config.SetVram(vram)
    ...
    if vram == var.vram.OFF then
        ...
        SetOption("Rendering", "FakeGPUVRAM", "20.0")
        SetOption("World/Streaming/PersistencyCache", "PoolBudgetKB", "4096")
        SetOption("Rendering", "DistantShadowsMaxBatchSize", "500")
        SetOption("RayTracing", "AccelerationStructureBuildNumMax", "64")
        SetOption("RayTracing/DynamicInstance", "UpdateProxyNumMax", "196")
